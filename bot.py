...
def start(update: Update, context=None):
    update.message.reply_text(
        ...
        "Меня создал Александр @kaimagic, самый <b>лучший</b> и самый <b>красивый</b> человек в этом мире.\n"
        "Чтобы помочь его суженой ряженой Мармеладке 😋🥰, Быковой Анне Дмитриевне сдать диплом.\n\n"
